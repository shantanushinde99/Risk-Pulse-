...
![RiskPulse Architecture](docs/architecture-banner.png) *(Note: Placeholder for banner image)*
...
start.bat
```
*Note: Make sure your Python virtual environment is configured correctly if you run into missing module errors.*
